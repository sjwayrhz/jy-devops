...
## 需要证书文件 /etc/gitlab/ssl/star_juneyaokc_com.pem
...
nginx['ssl_certificate'] = "/etc/gitlab/ssl/star_juneyaokc_com.pem"
nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/star_juneyaokc_com.key"
