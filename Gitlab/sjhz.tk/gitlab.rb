## 摘抄于gitlab 14.5.2
## 文件存储在 /etc/gitlab/gitlab.rb
## 需要证书文件 /etc/gitlab/ssl/1_gitlab.sjhz.tk_bundle.crt
## 需要证书密钥 /etc/gitlab/ssl/2_gitlab.sjhz.tk.key
## 所有修改的地方都含有  
...
## |-- gitlab.rb.bak
## `-- ssl
##     |-- 2_gitlab.sjhz.tk.key
##     `-- 1_gitlab.sjhz.tk_bundle.crt
## 
## 1 directory, 4 files
...
external_url 'https://gitlab.juneyaokc.com'  
...
nginx['ssl_certificate'] = "/etc/gitlab/ssl/1_gitlab.sjhz.tk_bundle.crt"
nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/2_gitlab.sjhz.tk.key"
